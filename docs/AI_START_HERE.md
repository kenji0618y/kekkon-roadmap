...
<!-- STATE:LINE -->
186項目 · 33まとまり · FAQ 2074組 · 出典 135件 · 6タブ · 検査 68項目
<!-- /STATE -->
...
Full minima → `CONTENT_GUARD.md` / HANDOFF HARD RULES（176 tasks, FAQ ≥930 ほか）。
...
Stamps: 絵が主役。縁のパッド **MAX=12**、溢れたら同じ絵でカード分割。横スクロールのギャラリー不可。
