...
await page.screenshot({ path: `${out}/v7-home-copy.png`, fullPage: false });

await page.goto("http://127.0.0.1:4173/#/map", { waitUntil: "networkidle" });
await page.waitForTimeout(700);
await page.getByRole("button", { name: /両社規程コピー/ }).first().click();
...
await page.locator(".stamp-sheet").screenshot({ path: `${out}/v7-stamp-why.png` });
